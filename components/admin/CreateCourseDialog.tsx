...
interface CreateCourseDialogProps {
  ...
  departmentId?: string; // Pre-select if available
}
...
export function CreateCourseDialog({
  ...
  const { data: departmentsData } = useDepartmentsQuery({ limit: 100 }); // Fetch all departments for select
  ...
  const form = useForm<CourseFormValues>({
    ...
    defaultValues: {
      ...
      level: 100,
      semester: "FIRST",
      academicYear: "2023/2024", // Default? Maybe dynamic
      isActive: true,
    },
  });
